...
<div class="container">
    ...
    <h5>Clique no treino para ver a imagem</h5>
    <?php
    include 'conexao.php';
    ...
    FROM treinos
    JOIN exercicios
    ON treinos.id_exercicio = exercicios.id_exercicio AND treinos.classe_treino = 's' AND treinos.id_aluno = $id_aluno
    JOIN aluno
